...
func (n *DropNotify) dumpIdentity(buf *bufio.Writer, numeric bool) {
	if numeric {
...
func (n *DropNotify) DumpInfo(data []byte, numeric bool) {
...
func (n *DropNotify) DumpVerbose(dissect bool, data []byte, prefix string, numeric bool) {
	buf := bufio.NewWriter(os.Stdout)
