...
func (n *TraceNotify) dumpIdentity(buf *bufio.Writer, numeric bool) {
	if numeric {
...
func (n *TraceNotify) DumpInfo(data []byte, numeric bool) {
...
func (n *TraceNotify) DumpVerbose(dissect bool, data []byte, prefix string, numeric bool) {
	buf := bufio.NewWriter(os.Stdout)
